...
> imgsz from the model (cap_ws `27dec07`). Round B (obj 4) ✅ **PASS, worst 33.8 cm, mean 21.9 cm** (back-pass tape corrected; left pass tape source unconfirmed) — see `records/calibration.md` → Objective 4. Still owed: C
