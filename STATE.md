...
> imgsz from the model (cap_ws `27dec07`). Round B (obj 4) run 24 Sep 20:52: **FAIL by 1.5 mm** (worst 50.15 cm, back; mean 26.0 cm), back pass flagged — see `records/calibration.md` → Objective 4. Still owed: C
